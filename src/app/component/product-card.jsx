...
const ProductCard = ({ product, index }) => {
  return (
    <motion.div
      ...
      viewport={{ once: true }}
      className="group relative bg-gradient-to-b from-slate-50 to-slate-100 shadow-lg hover:shadow-2xl transition-all duration-500 rounded md:rounded-lg overflow-hidden border border-amber-100"
    >
      ...
      <div className="relative w-full h-60 md:h-72 overflow-hidden bg-gradient-to-br from-slate-200 to-slate-300">
        <Image
